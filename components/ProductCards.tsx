...
export default function ProductCards({ item }: Product) {
  return (
    <div className="w-full flex flex-col gap-4 group cursor-pointer">
      <div
        className="aspect-[8/8] group-hover:shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] after:block after:absolute after:-top-full hover:after:-top-1/2 hover:after:-right-1/2 after:w-full after:-right-full after:transition-all after:duration-[900ms] after:ease-out after:scale-[141%] after:h-full after:bg-black/40 after:rotate-45 before:block before:ease-out before:absolute before:top-full before:w-full before:transition-all before:duration-[900ms] before:-left-full hover:before:top-1/2 hover:before:-left-1/2 before:scale-[141%] before:h-full before:bg-black/40 before:rotate-45 w-full flex items-center justify-center rounded-[20px] overflow-hidden shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] bg-cover bg-center relative"
